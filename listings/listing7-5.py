...
# The first print run of this book had a different Listing 7-5.
# There is an additional generate_map() instruction at the end now,
# brought forward from Listing 8-3.
