...
# The first print run of this book had a different Listing 8-3.
# If you have a copy from the first print run, listings 8-1 and 8-2
# are as they appear in your book; Listing 8-3 from your book is not included
# because that addition is now in Listing 7-5; and Listings 8-4 to the end of
# the chapter are now renumbered. So Listing 8-4 in your book is now this file
# Listing 8-3; Listing 8-5 in your book is file 8-4 and so on.
# In short: if you have a first printing, skip Listing 8-3.
# This change was required as a result of software updates.
# I hope it doesn't cause you any problems!
# For book updates, see https://www.sean.co.uk/books/mission-python/index.shtm
